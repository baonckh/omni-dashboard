...
const vi: Dict = {
  ...
  "pricing.sub": "Dùng thử 2 shop miễn phí. Nâng cấp từ $8/tháng.",
  ...
  "pricing.free_feat1": "Quản lý 2 shop",
  "pricing.free_feat2": "Tất cả kênh: Facebook, Zalo, TikTok, Shopee, IG",
  "pricing.free_feat3": "AI tự động trả lời 500 hội thoại/tháng",
  "pricing.free_feat4": "Cá tính bot cơ bản",
  "pricing.free_feat5": "Nhập sản phẩm từ CSV/text",
  "pricing.free_feat6": "Dashboard phân tích 7 ngày",
  ...
  "pricing.starter_feat1": "Quản lý 3 shop",
  "pricing.starter_feat2": "Tất cả kênh + ưu tiên",
  "pricing.starter_feat3": "AI tự động trả lời 3.000 hội thoại/tháng",
  "pricing.starter_feat4": "Cá tính bot tùy chỉnh + kịch bản",
  "pricing.starter_feat5": "Tự động học catalog thông minh",
  "pricing.starter_feat6": "Dashboard phân tích 90 ngày",
  ...
  "pricing.pro_desc": "Cho doanh nghiệp cần AI không giới hạn",
  "pricing.pro_feat1": "Quản lý 10 shop",
  "pricing.pro_feat2": "Tất cả kênh + tích hợp API",
  "pricing.pro_feat3": "AI trả lời không giới hạn",
  "pricing.pro_feat4": "AI nâng cao + dual-model",
  "pricing.pro_feat5": "Catalog + chính sách thông minh",
  "pricing.pro_feat6": "Dashboard phân tích không giới hạn",
  "pricing.pro_feat7": "Hỗ trợ chat ưu tiên 4h",
  "pricing.pro_feat8": "Thêm shop: +$6/tháng",
